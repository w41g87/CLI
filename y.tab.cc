...
{
       0,    64,    64,    65,    70,    74,    78,    81,    82,    88,
      95,    96,   100,   144,   152,   153,   157,   165,   173,   182,
     191,   202,   213,   217
};
#endif
...
{
      10,     8,    -8,    -8,     9,    -8,    -7,    -8,    -8,    -8,
      -8,    -8,    -8,    -2,    11,    15,    -8,    -8,    -8,    -8,
      -5,    16,    17,    18,    19,    20,    21,    -8,    -8,    -8,
      -8,    -8,    -8,    -8
};
...
{
       0,     0,    13,     5,     0,     2,    23,     7,    11,     6,
       1,     3,    22,     0,     0,    15,     8,     4,    12,    10,
       9,     0,     0,     0,     0,     0,     0,    14,    17,    21,
      20,    18,    19,    16
};
...
{
      21,     2,    22,    23,    24,    12,    25,    13,    26,    10,
       1,     1,     2,     2,     9,     3,     3,    17,    18,    28,
      29,    30,    31,    32,    33,    16,    11
};

static const yytype_uint8 yycheck[] =
{
       5,     3,     7,     8,     9,    12,    11,    14,    13,     0,
       1,     1,     3,     3,     6,     6,     6,     6,     3,     3,
       3,     3,     3,     3,     3,    13,     4
};
...
static const yytype_uint8 yystos[] =
{
       ...
       0,    17,    12,    14,    25,    20,    19,     6,     3,    21,
      23,     5,     7,     8,     9,    11,    13,    24,     3,     3,
       3,     3,     3,     3
};
...
#line 100 "shell.y" /* yacc.c:1646  */
    ...
    if ((yyvsp[0].cpp_string)->find('?') != std::string::npos || (yyvsp[0].cpp_string)->find('*') != std::string::npos) {
      ...
      while(exp[i++]);
      if (i == 1) {
        Command::_currentSimpleCommand->insertArgument( envExp((yyvsp[0].cpp_string)) );
      } else {
      ...
      if ((yyvsp[0].cpp_string)->find('/') != std::string::npos) {
        ...
        char * home = tilExp((yyvsp[0].cpp_string)->substr(0).c_str());
        delete (yyvsp[0].cpp_string);
